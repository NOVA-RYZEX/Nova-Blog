...
<template>
  <nav
    ...
    :data-aos="!reducedMotion ? 'fade-down' : undefined"
  ...
  >
    ...
    <div
      v-if="mounted"
      :style="bubbleStyles"
      class="absolute left-0 top-1.5 bottom-1.5 z-0 pointer-events-none rounded-full  shadow-[0_2px_8px_rgba(0,0,0,0.08)] dark:shadow-[0_4px_12px_rgba(0,0,0,0.3)] transition-all duration-300 ease-[cubic-bezier(0.25,1,0.5,1)]"
